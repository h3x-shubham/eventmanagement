    ...
    <body>
        ...
        <div class = "container"><!--body content holder-->
          ...
          <div class="row">
              ...
              <div class="col-sm-4">
              	<h3>Wedding</h3>
			<img src="images/wedding.jpg" class="img-responsive">
              </div>
          </div>
      </div>
         </div>
