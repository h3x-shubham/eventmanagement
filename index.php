                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <a href="events.php" type="button" class="btn btn-default btn-lg"><!--view event button (no function implemented)-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <hr class="customline"><!--css modified horizontal line-->
                            <a href="events3.php" type="button" class="btn btn-default btn-lg"><!--view event button (no function implemented)-->
                            View Events  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
                            </a>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <hr class="customline"><!--css modified horizontal line-->
                            <a href="events4.php" type="button" class="btn btn-default btn-lg"><!--view event button (no function implemented)-->
                            View Events  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
                            </a> 
                        </div><!--subcontent div-->
                    </div><!--container div-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <hr class="customline"><!--css modified horizontal line-->
                            <a href="events5.php" type="button" class="btn btn-default btn-lg"><!--view event button (no function implemented)-->
                            View Events  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon--> 
                            </a> 
                        </div><!--subcontent div-->
                    </div><!--container div-->
