        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> MIT-WPU</h1>
                    <p>
                        <a href = "mailto: mitwpu@egmail.com" span class="glyphicon glyphicon-envelope"></span> Email:mitwpu.edu.in</a><br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: www.mit-wpu.com/mit-wpu<br>
